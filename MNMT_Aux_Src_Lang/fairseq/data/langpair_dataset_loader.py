...
class LangpairDatasetLoader(object):
    ...
    def __init__(
        ...
        self.dataset_impl = dataset_impl if dataset_impl is not None else 'mmap'
    ...
    def load_langpair_langid_dataset(self, data_path, lang_pairs, is_bt=False):
        ...
        for lang_pair in lang_pairs:
            ...
            if self._split_exists(self.split, src, tgt, src, data_path) or self._split_exists(self.split, tgt, src, tgt, data_path):
                print(self.split, src, tgt, src, data_path)
        ...
        return LanguagePairLangidDataset(
            src_dataset, src_dataset_sizes, self.src_dict, src_langs,
            tgt_dataset, tgt_dataset_sizes, self.tgt_dict, tgt_langs,
    ...
    def _load_dataset_from_file(
        ...
        for k in itertools.count():
            ...
            elif self._split_exists(split_k, tgt, src, src, data_path):
