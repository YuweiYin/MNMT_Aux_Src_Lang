...
from .robust_emb_lang_pair import LanguagePairDataset
...
@register_task('robust_emb_translation')
class RobustEmbTranslationTask(FairseqTask):
    """
    ...
    def _inference_with_bleu(self, generator, sample, model):
        ...
        tokenize = sacrebleu.DEFAULT_TOKENIZER if not self.args.eval_tokenized_bleu else 'zh'
